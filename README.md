...
## 📄 My CV
https://github.com/AnnaNRomaniuk/AnnaR_Portfolio/blob/main/Anna%20Romaniuk_Middle%20QA.pdf

## 🧪 Skills
- SDLC/STLC: Requirements Analysis, Test Planning, QA Estimation, Test Execution
- Testing Types: Functional, UI/UX, Regression, Exploratory, Integration, Acceptance, Smoke
- Platforms: Desktop, Web, API, DB (using SQL) 
- Documentation: Test Plans, Test Cases, Checklists, Bug Reports; Traceability Matrix


## 📁 Projects

### 🛍️ Luxoft - Middle Manual QA Engineer
📅 May 2021 – Present

•	Desktop & DB testing using SQL
•	Test Execution: Acceptance, Smoke, Functional, UI/UX, Exploratory, Integration, Regression
•	QA documentation: Test Plans, Test Cases, Bug Reports, Traceability Matrix
•	Requirements Analysis, Test Planning, QA Estimation
•	Bug reporting, verification, log analysis 
Tools: Azure DevOps, SQL Server, Confluence, Figma
...
•	Web & API testing
•	Smoke, Functional, UI/UX, Exploratory, Integration tests
•	QA documentation & bug reporting

Tools: Chrome DevTools, HTML/CSS, Jira, TestRail, Postman, Selenium, Google Docs
